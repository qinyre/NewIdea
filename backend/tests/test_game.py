...
async def main():
    ...
    config = {
        ...
        "seed": 42,  # 固定种子，可复现
        "model_configs": {
            "AI-1": {"provider": "openai", "model": "gpt-4o-mini"},
            "AI-2": {"provider": "openai", "model": "gpt-4o-mini"},
            "AI-3": {"provider": "openai", "model": "gpt-4o-mini"},
            "AI-4": {"provider": "openai", "model": "gpt-4o-mini"},
            "AI-5": {"provider": "openai", "model": "gpt-4o-mini"},
        }
    }
